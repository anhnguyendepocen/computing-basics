...
These "must know" basics are in documented in a https://github.com/brianhigh/computing-basics/wiki[wiki] and are also compiled into a https://github.com/brianhigh/computing-basics/raw/master/computing_basics.pdf[PDF ebook].
